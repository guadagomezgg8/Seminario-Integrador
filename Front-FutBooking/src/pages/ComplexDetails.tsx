  ...
  canchas: [
    {
      ...
      tipo: "Fútbol 11",
      precio: 100,
      disponibilidades: ["10:00", "12:00", "14:00", "16:00", "18:00"],
      imagenUrl:
    ...
    {
      id: 2,
      nombre: "Cancha Auxiliar 1",
      tipo: "Fútbol 7",
      precio: 70,
      disponibilidades: ["11:00", "13:00", "15:00", "17:00", "19:00"],
      imagenUrl:
        "https://images.unsplash.com/photo-1529900748604-07564a03e7a6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    },
    {
      id: 3,
      nombre: "Cancha Auxiliar 2",
      tipo: "Fútbol 5",
      precio: 50,
      disponibilidades: ["09:00", "11:00", "13:00", "15:00", "17:00", "19:00"],
      imagenUrl:
...
export default function ComplexDetails() {
  ...
  const handleReserve = (canchaId: number) => {
    ...
    alert(
      `Reserva confirmada para la cancha ${canchaId} el ${selectedDate} a las ${selectedTimes[canchaId]}`
    );
  };
        ...
        <div className="bg-white shadow-2xl rounded-lg overflow-hidden mb-8">
          ...
          <div className="p-6">
            <div className="flex flex-wrap items-center text-gray-700 mb-4">
              ...
              <span>
                {mockComplex.direccion}, {mockComplex.localidad}
              </span>
            </div>
            <div className="flex flex-wrap items-center text-gray-700 mb-4">
              <Clock className="mr-2 text-blue-500" />
              <span>Rango Horario: {mockComplex.rangoHorario}</span>
            </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center mb-2 text-gray-600">
                  <span className="mr-2" role="img" aria-label="soccer">
                    ⚽
                  </span>
