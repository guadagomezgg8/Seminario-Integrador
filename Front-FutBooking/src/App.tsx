...
import ComplexDetails from "./pages/ComplexDetails"; // Importa tu nuevo componente
      ...
      <div className="flex flex-col min-h-screen w-full bg-gray-100">
        ...
        <main className="flex-grow w-full px-4 py-8">
          <Routes>
            ...
            <Route
              path="/admin/field-registration"
              element={<FieldRegistration />}
            />
            <Route
              path="/admin/complex-registration"
              element={<ComplexRegistration />}
            />
            ...
            <Route path="/complex-details/:id" element={<ComplexDetails />} />
          </Routes>
        </main>
        <Footer />
      </div>
